  ...
  if (!searchQuery.value) {
    ...
    return files.value.filter(
      (item) =>
        ...
        item.AuthorName.toLowerCase().includes(searchQuery.value.toLowerCase()) ||
        item.UnitCode.toLowerCase().includes(searchQuery.value.toLowerCase()) ||
        item.UnitName.toLowerCase().includes(searchQuery.value.toLowerCase())
    )
  }
})
