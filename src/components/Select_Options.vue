...
<template>
 ...
 <!-- *? Course Type -->
        <div class="select_option">
          ...
          >
            <!-- ADDED A KEY -->
            <option :value="course_type.CourseType" v-for="course_type in filteredCourseType" :key="course_type.ID">
...
<div class="select_option">
          ...
          >
            <!-- ADDED A KEY -->
            <option  :value="semester.Semester" v-for="semester in filteredSemester" :key="semester.ID">
              {{ semester.Semester }}
            </option>
          </select>
        </div>
